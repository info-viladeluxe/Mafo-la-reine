              ...
              return (
                <li key={e.id} className="flex items-center gap-4 py-3.5">
                  ...
                  <button
                    ...
                    className="grid h-8 w-8 place-items-center rounded-full text-neutral transition-colors hover:bg-terre-50 hover:text-terre-500 dark:hover:bg-terre-500/10"
                  >
                    <Trash2 size={15} />
                  </button>
                </li>
        ...
        <div className="fixed inset-0 z-50 flex items-end justify-center sm:items-center">
          ...
          <div className="relative m-0 w-full max-w-md animate-fade-up rounded-t-3xl bg-sable-50 p-6 shadow-soft-lg sm:m-4 sm:rounded-3xl dark:bg-indigo-300">
            <div className="mb-4 flex items-center justify-between">
              ...
              <button onClick={() => setShowForm(false)} aria-label={t('cycle.cancel')} className="grid h-8 w-8 place-items-center rounded-full text-neutral hover:bg-aubergine-50 dark:hover:bg-white/5">
                <X size={18} />
              </button>
            </div>
