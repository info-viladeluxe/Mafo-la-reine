        ...
        <div className="fixed inset-0 z-50 flex items-end justify-center sm:items-center">
          ...
          <div className="relative m-0 max-h-[92vh] w-full max-w-lg overflow-y-auto rounded-t-3xl bg-sable-50 p-6 shadow-soft-lg sm:m-4 sm:rounded-3xl dark:bg-indigo-300">
            <div className="mb-4 flex items-center justify-between">
              ...
              <button onClick={() => setShowForm(false)} aria-label={t('sym.cancel')} className="grid h-8 w-8 place-items-center rounded-full text-neutral hover:bg-aubergine-50 dark:hover:bg-white/5">
                <X size={18} />
              </button>
            </div>
